...
def plot_seasonal_decompose(timeseries):
...
def plot_arima_forecast(real_values, forecast_values, confidence_intervals, title):
...
def plot_svm(timestamps, y_test, svm_predictions):
